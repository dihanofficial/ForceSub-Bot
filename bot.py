...
@Dihanofficial.on_callback_query(static_data_filter)
...
@Dihanofficialt.on_message(filters.text & ~filters.private & ~filters.edited, group=1)
...
@Dihanofficial.on_message(filters.command("start") & ~filters.group & ~filters.channel)
